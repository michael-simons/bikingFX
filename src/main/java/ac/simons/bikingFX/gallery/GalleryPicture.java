...
public class GalleryPicture {
	...
	public GalleryPicture(final JsonNode json) {

		this.id = new ReadOnlyObjectWrapper<>(this, "id", json.get("id").asInt());
		this.takenOn = new ReadOnlyObjectWrapper<>(this, "takenOn", LocalDate.parse(json.get("takenOn").textValue()));
		this.filename = new ReadOnlyObjectWrapper<>(this, "filename", json.get("filename").textValue());
		this.description = new SimpleStringProperty(this, "description", json.get("description").textValue());
	}
